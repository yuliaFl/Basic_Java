...
public class game { //begin class
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(game.class.getResource("/gameimage/imgres.png")));
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(game.class.getResource("/imagegame2/imgres.jpg")));
