 ...
 * February 28 2017 
 * Version 1.0
 * First Gui prooject, kind of in the theme of where to go in the summer 
*/
...
public class Guiproject { // begin class
	 ...
	 */
	public static void main(String[] args) { //begin public void 
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon("/Users/morkovka/Desktop/pic_mountain.jpg"));
		...
		btnShowText.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//txtrTipsForTraveling.setVisible(true);
				txtrTipsForTraveling.setText("Now I'm visible" );
			}
		});
		...
		lblNewLabel_1.setBounds(525, 117, 61, 16);
